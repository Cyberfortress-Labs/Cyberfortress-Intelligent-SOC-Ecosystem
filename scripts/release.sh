#!/bin/bash
# =============================================================================
# Intelligent SOC Ecosystem Release Script
...
echo -e "${BLUE}=== Cyberfortress Intelligent SOC Ecosystem Release Script ===${NC}"
...
echo -e "  - Build Docker images with tag ${TAG}"
echo -e "  - Create GitHub Release automatically"
echo ""
echo -e "Check progress at: ${BLUE}https://github.com/Cyberfortress-Labs/Cyberfortress-Intelligent-SOC-Ecosystem/actions${NC}"
